<?php
 ...
 $qry = "select DISTINCT id_merchant,merchant_name,merchant_logo,merchant_status from(SELECT s.id_store,s.store_location_lat,s.store_location_lng,s.store_created_at,s.store_updated_at,m.id_merchant,m.merchant_name,m.merchant_status,m.merchant_logo,
(((acos(sin((".$lat."*pi()/180)) * 
